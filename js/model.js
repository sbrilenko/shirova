  		...
  		$('#one').append('<div id="f" style="min-width:910px;">'+arr[0]+'</div>');
         		 	$('div#model').live('click',function() {
         		 		var spl=$(this).attr('class').split('_');
  						  ...
  						  id_big_photo=spl[1];
         		 		$('#one').append('<div id="th" style="min-width:910px;">'+arr2[0]+'<div style="clear:both;"><div style="max-height:100px;overflow:hidden;margin-top:-100px;text-align:left;padding:0">'+'<br>'+name_slide2+'<br>'+descript_slide2+'<br><br><br><br><br><span id="click_return_model" > < назад</span></div></div>');   	
         		...
         		$('#click_return_model').live('click touchend',function() {
          	 		 $('div#one div#th').hide();
          	 		  count=count_back;
        		  ...
        		  $('#click_return_picture').live('click touchend',function() {
          	 		 $('div#one div#ss').hide();
          	 			if(count>0) {$('.float_left_arrow').show();}
          	 		 		if(count==0) {$('.float_left_arrow').hide();}
          	 		 		if(count<total_arr-1) {$('.float_right_arrow').show();}
        		  ...
        		  $('#one div >div#galery_model').live('click touchend',function() {
        		  	 $('div#one div#th').hide();
         		 ...
         		 $('#ss').live('click touchend',function() {
        		  			$('div#one div#ss').hide();
          	 			if(count>0) {$('.float_left_arrow').show();}
          	 		 		if(count==0) {$('.float_left_arrow').hide();}
          	 		 		if(count<total_arr-1) {$('.float_right_arrow').show();}
					...
					$('div#one').animate({marginLeft:'0px'},500);
  					...
  					$('.float_left_arrow').show();
  				   	...
  				   	$('div#one').css('margin-left','-910px');
  				   		count+=1;
  				   	 $('div#one div#th').replaceWith('');
					  $('div#one').append('<div id="th" style="min-width:910px;">'+arr2[count]+'<div style="clear:both;"><div style="margin-top:-100px;text-align:left;">'+'<br>'+name_slide2+'<br>'+descript_slide2+'<br><br><br><br><br><span id="click_return_model" > < назад</span></div></div>');
					$('div#one').animate({marginLeft:'0px'},500);
						$('.preloader').hide();
					...
					$('div#one').animate({marginLeft:'0px'},500);
  					...
  					$('div#one').animate({marginLeft:'-910px'}, 500,function() {
  				   	$('div#one').css('margin-left','910px');
  				   		count-=1;
  				   	 $('div#one div#th').replaceWith('');
  				 $('div#one').append('<div id="th" style="min-width:910px;">'+arr2[count]+'<div style="clear:both;"><div style="margin-top:-100px;text-align:left;">'+'<br>'+name_slide2+'<br>'+descript_slide2+'<br><br><br><br><br><span id="click_return_model" > < назад</span></div></div></div>');
					$('div#one').animate({marginLeft:'0px'},500);
  					$('.preloader').hide();
  					});
